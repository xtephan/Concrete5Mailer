...
<?php echo Loader::helper('concrete/dashboard')->getDashboardPaneHeaderWrapper(t('SMTP Settings'), false, 'span8 offset2', false)?>
<form method="post" action="<?php echo $this->url('/dashboard/mail/smtp_settings', 'save_settings')?>" class="form-horizontal" id="mail-settings-form">
    ...
    <div class="ccm-pane-body">
        ...
        <input style="display: none" type="radio" name="MAIL_SEND_METHOD" id="MAIL_SEND_METHOD2" value="SMTP" class="ccm-input-radio" checked="checked">

        <fieldset id="ccm-settings-mail-smtp">
            <legend><?php echo t('SMTP Server Settings')?></legend>
            <div class="control-group">
    ...
    <div class="ccm-pane-footer">
        <a href="<?php echo $this->url('/dashboard/mail/smtp_settings/test_settings')?>" class="btn"><?php echo t('Test Settings')?></a>
